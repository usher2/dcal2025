...
\begin{document}
    ...
    \pic [folding line length=11em,
        ...
        \node[align=center, text width=11em,inner sep=0, text=BlockQuoteColor] at (0, -2.1) {\begin{spacing}{0.8}\scriptsize\textit{\textbf{Woreguard}: очень простой протокол VPN, легко обнаруживается}\end{spacing}};},
