...
\begin{document}
    ...
    \pic [folding line length=11em,
        ...
        \node[align=center, text width=11em,inner sep=0, text=BlockQuoteColor] at (0, -1.9) {\begin{spacing}{0.8}\scriptsize\textit{\textbf{Tor}: (луковый маршрутизатор) - позволяет относительно анонимно пользоваться сетью и обходить блокировки}\end{spacing}};},
